...
CREATE TABLE comuna(COMUNA_ID integer DEFAULT 0 NOT NULL, COMUNA_NOMBRE character varying(20), COMUNA_PROVINCIA_ID integer);
ALTER TABLE public.comuna OWNER TO postgres;
CREATE TABLE provincia(PROVINCIA_ID integer DEFAULT 0 NOT NULL, PROVINCIA_NOMBRE character varying(23), PROVINCIA_REGION_ID integer);
ALTER TABLE public.provincia OWNER TO postgres;
CREATE TABLE region(REGION_ID integer DEFAULT 0 NOT NULL, REGION_NOMBRE character varying(50));
...
ALTER TABLE ONLY comuna ADD CONSTRAINT comuna_pkey PRIMARY KEY (COMUNA_ID);
ALTER TABLE ONLY provincia ADD CONSTRAINT provincia_pkey PRIMARY KEY (PROVINCIA_ID);
ALTER TABLE ONLY region ADD CONSTRAINT region_pkey PRIMARY KEY (REGION_ID);
...
ALTER TABLE ONLY comuna ADD CONSTRAINT comuna_COMUNA_PROVINCIA_ID_fkey FOREIGN KEY (COMUNA_PROVINCIA_ID) REFERENCES provincia(PROVINCIA_ID);
ALTER TABLE ONLY provincia ADD CONSTRAINT provincia_PROVINCIA_REGION_ID_fkey FOREIGN KEY (PROVINCIA_REGION_ID) REFERENCES region(REGION_ID);
