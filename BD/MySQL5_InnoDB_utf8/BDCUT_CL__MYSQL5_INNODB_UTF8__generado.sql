...
CREATE TABLE IF NOT EXISTS comuna (COMUNA_ID int(5) NOT NULL DEFAULT '0', COMUNA_NOMBRE varchar(20) DEFAULT NULL, COMUNA_PROVINCIA_ID int(3) DEFAULT NULL, PRIMARY KEY (COMUNA_ID), KEY COMUNA_PROVINCIA_ID (COMUNA_PROVINCIA_ID) ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ;
CREATE TABLE IF NOT EXISTS provincia (PROVINCIA_ID int(3) NOT NULL DEFAULT '0', PROVINCIA_NOMBRE varchar(23) DEFAULT NULL, PROVINCIA_REGION_ID int(2) DEFAULT NULL, PRIMARY KEY (PROVINCIA_ID), KEY PROVINCIA_REGION_ID (PROVINCIA_REGION_ID) ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ;
CREATE TABLE IF NOT EXISTS region(REGION_ID int(2) NOT NULL DEFAULT '0', REGION_NOMBRE varchar(50) DEFAULT NULL,PRIMARY KEY (REGION_ID) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE comuna ADD CONSTRAINT comuna_COMUNA_PROVINCIA_ID_fkey FOREIGN KEY (COMUNA_PROVINCIA_ID) REFERENCES provincia(PROVINCIA_ID) ON UPDATE CASCADE;
ALTER TABLE provincia ADD CONSTRAINT provincia_PROVINCIA_REGION_ID_fkey FOREIGN KEY (PROVINCIA_REGION_ID) REFERENCES region(REGION_ID) ON UPDATE CASCADE;
